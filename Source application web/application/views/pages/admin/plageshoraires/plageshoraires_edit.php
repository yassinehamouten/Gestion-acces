            ...
            <div class="col-xs-12">
                ...
                <?php echo form_open(); ?>
                    <div class="row">
                                    ...
                                    <optgroup label="Salles">
                                        <?php 
                                            ...
                                            foreach ($query->result() as $row){
                                                if($row->idSalle == $plagehoraire[0]->idSalle){
                                                    echo '<option value="'.$row->idSalle.'" selected>'.$row->nomSalle.'</option>';
                                                }else{
                                ...
                                <select name="idClasse">
                                    <optgroup label="Classes">
                                        <?php 
                                            ...
                                            foreach ($query->result() as $row){
                                                if($row->idClasse == $plagehoraire[0]->idClasse){
                                ...
                                <select name="idStatut">
                                    <optgroup label="Statuts">
                                        <?php 
                                            ...
                                            foreach ($query->result() as $row){
                                                if($row->idStatut == $plagehoraire[0]->idStatut){
                        ...
                        <div class="col-sm-12">
                            <input type="hidden" class="form-control" id="debut" name="debut" value="<?php echo $plagehoraire[0]->debut ?>">
                        </div>
                        <div class="col-sm-12">
                            <input type="hidden" class="form-control" id="fin" name="fin" value="<?php echo $plagehoraire[0]->fin ?>">
                        </div>
                    </div>
